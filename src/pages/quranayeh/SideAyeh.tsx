...
import "./SideAyeh.css";
import { changeSideShow , changeCopyAyeh , changeShareAyeh } from "../../redux/sideAyeh/sideAyehSlice";
const SideAyeh = () => {
  ...
  return (
    <div className="mainAyehSideItem">
      <div className="AyehSideItem">
        ...
        <button className="AyehSideItemButton" onClick={() => {dispatch(changeCopyAyeh(true)) ; dispatch(changeSideShow(false))}}>
          <i className="AyehSideItemIcon">
        ...
        <button className="AyehSideItemButton" onClick={() => {dispatch(changeShareAyeh(true)) ; dispatch(changeSideShow(false))}}>
          <i className="AyehSideItemIcon">
